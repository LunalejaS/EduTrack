...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Curso creado correctamente' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de Cursos obtenida' }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Obtener un Curso por su ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Curso eliminado con éxito' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Curso no encontrado' }),
